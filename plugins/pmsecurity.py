...
# This file is a part of < https://github.com/loverboyXD/scorpion/ >
...
from scorpion.functions.pmpermit_db import *
...
if Redis("PMPIC"):
    ...
    PMPIC = "https://telegra.ph/file/440a2d86ee378c3fc60c6.jpg"
...
**PMSecurity of {ON}! Don't spam else you will be kicked to blocklist 😗**
...
@scorpion.on(events.NewMessage(incoming=True, func=lambda e: e.is_private))
...
if sett == "True" and sett != "False":
    ...
    @scorpion.on(events.NewMessage(outgoing=True, func=lambda e: e.is_private))
    ...
    @scorpion_cmd(pattern="(a|approve)(?: |$)")
    ...
    @scorpion_cmd(pattern="(da|disapprove)(?: |$)")
