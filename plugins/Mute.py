...
# Below is the link of the License
...
from scorpion.functions.all import ban_time
from scorpion.functions.mute_db import is_muted, mute, unmute
...
@scorpion_bot.on(events.NewMessage(incoming=True))
