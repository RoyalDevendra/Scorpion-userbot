...
from scorpion.functions.asst_fns import *

from telethon import Button, custom, events

from telegraph import Telegraph, upload_file

from scorpion import CUSTOM_PMPERMIT
            ...
            await tgbot.send_file(event.chat_id,
                                  ...
                                  buttons=[
                                      ...
                                      (Button.inline(
                                          ...
                                          text = "OUU CAN CONTACT MY MASTER {} FROM HERE"
            ...
            await tgbot.send_message(event.chat_id,
                                     ...
                                     buttons=[
                                         ...
                                         (Button.inline(
                                             ...
                                             text = "YOU CAN CONTACT MY MASTER {} FROM HERE"))]
            ...
            await tgbot.send_file(event.chat_id,
                                  ...
                                  buttons=[
                                      ...
                                      [Button.url(
                                          ...
                                          "scorpion", url="https://github.com/loverboyXD/scorpion.git")],

                                      [Button.inline(

                                          "Whats this?", text = "THIS IS A USERBOT of my master get YOUR also to make your own bot join ( @scorpion_helpchat) here✌️we will help you")]
    ...
    await tgbot.send_message(event.chat_id,
                             ...
                             buttons=[
                                 ...
                                 [Button.url("Support",
                                             ...
                                             url="https://t.me/scorpion_helpchat")]
...
async def logs(event):
    ...
    await tgbot.send_file(
        ...
        caption="**Heroku** `scorpion` Logs",

        buttons=[

            [Button.url("View Online", f"{url}")],

            [Button.url("Crashed?", "t.me/scorpion_helpchat")]
    ...
    await tgbot.send_message(event.chat_id,
                             ...
                             buttons=[
                                     ...
                                     [Button.inline(
                                         ...
                                         "Deploy me for yourself", data = "deployhere")]

                             ])

@tgbot.on(events.callbackquery.CallbackQuery(data=re.compile(b"scorpion"))
...
async def settings(event):
    ...
    await tgbot.send_message(event.chat_id,
                             ...
                             f"This is the personal help bot of {SCORPION_NAME}. You can contact me using this bot if necessary, or if I missed out your PM.",
...
@tgbot.on(events.callbackquery.CallbackQuery  (data=re.compile(b"deployhere"))
...
async def settings(event):
    ...
    await event.edit("Browse through the available options:",
                     ...
                     buttons=[
                         ...
                         [(Button.url("Repository", url="https://github.com/loverboyXD/scorpion.git")),

                         [Button.url("Support for help",
...
async def bot(event):
    ...
    if event.sender_id == OWNER_ID:
        ...
        xx = await tgbot.send_message(event.chat_id, "Changing your Bot Pic, please wait for a minute to restart")

        heroku_var = app.config()

        heroku_var[scorpion] = f"{url}"

        mssg = f"Successfully changed your bot pic. Please wait for a minute for restart.\n"
...
@tgbot.on(events.callbackquery.CallbackQuery(data=re.compile(b"scorpionbroad"))
